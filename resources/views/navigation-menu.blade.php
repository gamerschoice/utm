                ...
                <nav class="space-y-1 px-2">
                    ...
                    <div x-data="{ active: '{{ request()->routeIs('domain.*') }}' }"  
                        ...
                        <a href="{{ route('domain.index') }}" class="flex items-center">
                            ...
                            <span class="bg-blue-100  ml-3 inline-block rounded-full py-0.5 px-3 text-xs font-medium">3</span>
                        </a>
                        <div class="transition group-hover:bg-white bg-gray-100 mt-3 rounded-md px-3 py-2">
                            <ul class="list-none divide-y">
                                ...
                                <li class="text-sm font-light py-2"><a href="#" class="inline-block px-2 py-1 bg-blue-100 text-xs rounded-md">view all domains</a></li>
                            </ul>
                        </div>
                    </div>
