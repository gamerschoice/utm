				...
				<div class="px-4 py-5 sm:p-6">
					...
					<div class="mt-2 max-w-xl text-sm text-gray-500 ">
						...
						@else
							...
							<p class="mt-4 text-sm">Please note: if you've recently updated your DNS to point to UTM Wise, and your status is still pending, please be patient. This can sometimes, though rarely, take a couple of hours to verify.</p>
