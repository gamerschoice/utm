                ...
                <div class="px-4 py-5 sm:p-6 text-center">
                    ...
                    <div class="my-6 mx-auto w-full lg:w-2/3 xl:w-1/2 transform divide-y divide-gray-100 overflow-hidden rounded-xl bg-gray-50 shadow-lg ring-1 ring-black ring-opacity-5 transition-all">
                        <div class="relative">
                            ...
                            <input @click.prevent="$el.focus(); $el.select(); window.navigator.clipboard.writeText('{{ $link->full_url }}');" type="text" class="h-12 w-full border-0 bg-transparent pl-11 pr-4 text-gray-900 placeholder:text-gray-400 focus:ring-0" value="{{ $link->full_url }}" />
                        </div>
                    </div>
                    ...
                    <div class="mt-5 flex justify-center items-center gap-5">
                        ...
                        <a href="{{ route('domain.links', $domain['id']) }}">
