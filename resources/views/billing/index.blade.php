                    ...
                    @if($team->hasPaymentMethod())
                        <section class="bg-white shadow sm:rounded-lg">
                            <div class="px-4 py-5 sm:p-6">
                                ...
                                @foreach($team->paymentMethods() as $method)
                                <div class="mt-5">
                                    ...
                                    <div class="sm:flex sm:items-start">
                                        ...
                                        <div class="text-sm font-medium text-gray-900">Ending with {{ $method->card->last4 }}</div>
